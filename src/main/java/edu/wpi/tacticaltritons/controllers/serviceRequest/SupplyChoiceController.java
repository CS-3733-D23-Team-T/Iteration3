...
public class SupplyChoiceController {
    ...
    public void initialize() throws NullPointerException {
        ...
        uniqueShops.forEach((key, value) -> {
            createSupplyShopButton(value, App.supplyHashMap);
        });
    }

    private void createSupplyShopButton(SupplyRequestOptions value, HashMap<String, Image> imageHashMap) {
        ...
        Image image = imageHashMap.get(value);
