...
//    EffectGenerator.generateShadowEffect(basePane);
    this.comboBox.setItems(FXCollections.observableArrayList("Meal Request", "Flower Request", "Conference Request", "Furniture Request"));

    this.comboBox.setOnAction(
        event -> {
          if (comboBox.getValue().equals("Meal Request")) {
            ...
            tableMeal.setPrefWidth(tableInsert.getWidth());
            tableMeal.setPrefHeight(tableInsert.getHeight());
            tableInsert.getChildren().add(tableMeal);
          }
          if (comboBox.getValue().equals("Flower Request")) {
            tableInsert.getChildren().clear();
            ...
            tableFlower.setPrefWidth(tableInsert.getWidth());
            tableFlower.setPrefHeight(tableInsert.getHeight());
            tableInsert.getChildren().add(tableFlower);
          }
          if (comboBox.getValue().equals("Conference Request")) {
            tableInsert.getChildren().clear();
            ...
            tableConference.setPrefHeight(tableInsert.getHeight());
            tableInsert.getChildren().add(tableConference);
          }
          if (comboBox.getValue().equals("Furniture Request")){
            ...
            tableFurniture.setPrefWidth(tableInsert.getWidth());
            tableFurniture.setPrefHeight(tableInsert.getHeight());
            tableInsert.getChildren().add(tableFurniture);
          }
        });
