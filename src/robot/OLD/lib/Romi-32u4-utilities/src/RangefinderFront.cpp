 ...
 * */
RangefinderFront::RangefinderFront(uint8_t echo, uint8_t trig) 
{
    echoPin = echo;
    trigPin = trig;
}
...
void RangefinderFront::init(void)
{
 ...
 */
uint8_t RangefinderFront::checkPingTimer(void)
{
...
uint16_t RangefinderFront::checkEcho(void)
{
...
float RangefinderFront::getDistance(void)
{
 ...
 * */
void RangefinderFront::ISR_echo(void)
{
