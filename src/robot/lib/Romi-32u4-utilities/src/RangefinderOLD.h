...
protected:
    ...
    volatile uint32_t pulseStartS = 0;
    volatile uint32_t pulseEndS = 0;
...
extern Rangefinder sideRangefinder;
extern Rangefinder frontRangefinder;
